...
const Projects: React.FC = () => {
  ...
  return (
    <>
      <h1 className="xl:text-5xl xxxs:text-3xl text-white font-semibold mb-5 ml-3 text-right">
        {t('projects.title')}
      </h1>
      ...
      <div className="mt-8 max-w-12xl">
        ...
        <div className="mt-6 flex flex-wrap justify-center max-w-3xl mx-auto sm:max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-5xl" style={{ height: '280px' }}>
          {images[activeStep].technologies.map((tech, index) => (
            <div
              key={index}
              className="w-full xxxs:w-1/2 xxs:w-1/3 sm:w-1/3 md:w-1/3 lg:w-1/4 xl:w-1/4 mb-2 px-2"
            >
